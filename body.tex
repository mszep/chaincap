...
For the ``restricted'' calculations, the \ac{CI} space was truncated to contain
...
of wavefunction methods to the study of semi-infinite systems using a
self-energy-derived complex absorbing potential. For different degrees of
molecule-lead coupling and different levels of correlation, the complex
quasiparticle peaks of system consisting of an atomic gold chain were
evaluated. The ability to accurately describe these levels (which in this case
correspond to \ac{IP} and \ac{EA}) has been shown to be closely related to an
accurate description of transport~\cite{golden}.
