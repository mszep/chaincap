...
\ac{LDA} approximation are treated as \acp{QP} and the electron
...
or \ac{QP} approximation to the many-electron Green's function,
...
\ac{QP} description. Alternative to these methods are to use the
