...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.9\linewidth]{figures/ci45A.eps}
	\end{center}
	\caption{CI for the 4.5A system}
	\label{fig:cipeaks45A}
\end{figure}


\begin{figure}
	\begin{center}
		\includegraphics[width=0.9\linewidth]{figures/ci40A.eps}
	\end{center}
	\caption{CI for the 4.0A system}
	\label{fig:cipeaks40A}
\end{figure}
